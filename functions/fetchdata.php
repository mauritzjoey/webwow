  ...
  if($stmt->num_rows > 0) {
      while($stmt->fetch()) {
        ...
        foreach($list_class as $val){
          switch($val) {
            case"1":
            $class = "<img src='images/icons/class_warrior.gif' title=$list_name[$index] alt='class'>";
            break;
    
            case"2":
            $class = "<img src='images/icons/class_paladin.gif' title=$list_name[$index] alt='class'>";
            break;
    
            case"3":
            $class = "<img src='images/icons/class_hunter.gif' title=$list_name[$index] alt='class'>";
            break;
    
            case"4":
            $class = "<img src='images/icons/class_rogue.gif' title=$list_name[$index] alt='class'>";
            break;
    
            case"5":
            $class = "<img src='images/icons/class_priest.gif' title=$list_name[$index] alt='class'>";
            break;
    
            case"6":
            $class = "<img src='images/icons/class_deathknight.gif' title=$list_name[$index] alt='class'>";
            break;
    
            case"7":
            $class = "<img src='images/icons/class_shaman.gif' title=$list_name[$index] alt='class'>";
            break;
    
            case"8":
            $class = "<img src='images/icons/class_mage.gif' title=$list_name[$index] alt='class'>";
            break;
    
            case"9":
            $class = "<img src='images/icons/class_warlock.gif' title=$list_name[$index] alt='class'>";
            break;
    
            case"11":
            $class = "<img src='images/icons/class_druid.gif' title=$list_name[$index] alt='class'>";
            break;
          }
          $index = $index+1;
          echo " $class";
