        ...
        <div class="panel panel-default">
          ...
          <div class="btn-group btn-group-justified" role="group" aria-label="...">
            <div class="btn-group" role="group">
              <button type="button" class="btn btn-primary">Honor</button>
            </div>
            <div class="btn-group" role="group">
              <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">1v1<span class="caret"></span></button>
            ...
            <div class="btn-group" role="group">
              <button type="button" class="btn btn-primary">2v2</button>
            </div>
            <div class="btn-group" role="group">
              <button type="button" class="btn btn-primary">3v3</button>
            </div>
            <div class="btn-group" role="group">
              <button type="button" class="btn btn-primary">3v3 SoloQ</button>
            </div>
          </div>
          </div>
        </div>
